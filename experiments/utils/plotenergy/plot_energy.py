...
total_energy = [
    0.94, 1710, 293, 304, 2901, 6014, 408, 432, 280, 14765, 82, 71
]
...
plt.xlabel('Total Energy Consumed (mWh)', fontsize=font_size)
plt.xticks(fontsize=font_size)

plt.tight_layout()
plt.grid(True, which='both', axis='x', linestyle='--', alpha=0.7)
plt.savefig('energy-consumption.pdf', format='pdf')
